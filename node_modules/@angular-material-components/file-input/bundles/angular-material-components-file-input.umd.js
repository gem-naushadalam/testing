(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ng.core,global.ng.cdk.platform,global.ng.forms,global.ng.material.core,global.ng.material.button,global.ng.material.formField,global.ng.common,global.ng.material.icon,global.ng.material.input,(global['angular-material-components'] = global['angular-material-components'] || {}, global['angular-material-components']['file-input'] = {}), global.ng.cdk.coercion, global.ng.cdk.platform, global.ng.core, global.ng.forms, global.ng.material.core, global.ng.material.formField, global.rxjs, global.ng.common, global.ng.material.button, global.ng.material.icon, global.ng.material.input));
}(this, (function (ɵngcc0,ɵngcc1,ɵngcc2,ɵngcc3,ɵngcc4,ɵngcc5,ɵngcc6,ɵngcc7,ɵngcc8,exports, coercion, platform, core$1, forms, core, formField, rxjs, common, button, icon, input) { 
var _c0 = ["inputFile"];
var _c1 = ["inputValue"];
...
'use strict';
    ...
    ***************************************************************************** */
    ...
    var NgxMatInputBase = /** @class */ (function () {
        function NgxMatInputBase(_defaultErrorStateMatcher, _parentForm, _parentFormGroup, 
        /** @docs-private */
        ngControl) {
    ...
    var _NgxMatInputMixinBase = core.mixinErrorState(NgxMatInputBase);
        ...
        NgxMatFileInputComponent.prototype._updateInputValue = function (files) {
            ...
            if (files) {
                if (Array.isArray(files)) {
                    text = this._multiple
                        ? files.map(function (x) { return x.name; }).join(this.separator)
                        : files[0].name;
                }
                else {
...
NgxMatFileInputComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: NgxMatFileInputComponent, selectors: [["ngx-mat-file-input"]], contentQueries: function NgxMatFileInputComponent_ContentQueries(rf, ctx, dirIndex) { if (rf & 1) {
        ...
        ɵngcc0.ɵɵqueryRefresh(_t = ɵngcc0.ɵɵloadQuery()) && (ctx._inputValueRef = _t.first);
            ...
            { provide: formField.MatFormFieldControl, useExisting: core$1.forwardRef(function () { return NgxMatFileInputComponent; }) }
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(NgxMatFileInputComponent, [{
    ...
    NgxMatFileInputComponent.propDecorators = {
        _inputFileRef: [{ type: core$1.ViewChild, args: ['inputFile', { static: true },] }],
        _inputValueRef: [{ type: core$1.ViewChild, args: ['inputValue', { static: true },] }],
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(NgxMatFileInputModule, [{
    ...
    function MaxSizeValidator(max) {
        return function (ctrl) {
            ...
            var sumSize = files.map(function (x) { return x.size; }).reduce(add);
            if (sumSize > max) {
                return {
                    maxSize: true
                };
