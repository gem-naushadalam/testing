(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),require('@angular/common'),require('@angular/router'),exports, require('@angular/core'), require('@angular/common'), require('@azure/msal-browser'), require('rxjs'), require('@angular/router'), require('rxjs/operators')) :
    typeof define === 'function' && define.amd ? define('@azure/msal-angular', ['@angular/core','@angular/common','@angular/router','exports', '@angular/core', '@angular/common', '@azure/msal-browser', 'rxjs', '@angular/router', 'rxjs/operators'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ng.core,global.ng.common,global.ng.router,(global.azure = global.azure || {}, global.azure['msal-angular'] = {}), global.ng.core, global.ng.common, global['@azure/msal-browser'], global.rxjs, global.ng.router, global.rxjs.operators));
}(this, (function (ɵngcc0,ɵngcc1,ɵngcc2,exports, core, common, msalBrowser, rxjs, router, operators) { 'use strict';
...
MsalService.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: MsalService, factory: function (t) { return MsalService.ɵfac(t); } });
...
MsalBroadcastService.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: MsalBroadcastService, factory: function (t) { return MsalBroadcastService.ɵfac(t); } });
...
MsalGuard.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: MsalGuard, factory: function (t) { return MsalGuard.ɵfac(t); } });
...
MsalInterceptor.ɵfac = function MsalInterceptor_Factory(t) { return new (t || MsalInterceptor)(ɵngcc0.ɵɵinject(MSAL_INTERCEPTOR_CONFIG), ɵngcc0.ɵɵinject(MsalService), ɵngcc0.ɵɵinject(ɵngcc1.Location), ɵngcc0.ɵɵinject(common.DOCUMENT)); };
MsalInterceptor.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: MsalInterceptor, factory: function (t) { return MsalInterceptor.ɵfac(t); } });
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(MsalModule, { declarations: [MsalRedirectComponent], imports: [ɵngcc1.CommonModule] }); })();
...
MsalCustomNavigationClient.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: MsalCustomNavigationClient, factory: function (t) { return MsalCustomNavigationClient.ɵfac(t); } });
