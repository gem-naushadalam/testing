...
export const msalConfig: Configuration = {
    auth: {
        clientId: '539354e5-492a-42b7-8153-2ebd5002faca', // This is the ONLY mandatory field that you need to supply.
        ...
        // redirectUri: 'https://misnonprod.geminisolutions.com', // Points to window.location.origin. You must register this URI on Azure portal/App Registration.
